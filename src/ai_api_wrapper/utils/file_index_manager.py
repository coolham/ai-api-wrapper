...
class FileIndexManager:
    ...
    def generate_index(self, directory: str) -> Dict[str, dict]:
        ...
        try:
            ...
            logger.info(f"文件索引已更新: {index_file_path}")
            return existing_index
            
        except Exception as e:
            logger.error(f"生成文件索引时发生错误: {str(e)}")
            raise
    ...
    def update_analysis_status(self, directory: str, filename: str) -> None:
        ...
        try:
            ...
            logger.info(f"已更新文件分析状态: {filename}")
            
        except Exception as e:
            logger.error(f"更新文件分析状态时发生错误: {str(e)}")
            raise
    ...
    def update_summary_status(self, directory: str, filenames: List[str], summary_id: str) -> None:
        ...
        try:
            ...
            logger.info(f"已更新文件汇总状态: {summary_id}")
            
        except Exception as e:
            logger.error(f"更新文件汇总状态时发生错误: {str(e)}")
            raise
